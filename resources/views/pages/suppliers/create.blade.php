            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Thêm mới nhà cung cấp</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('suppliers.store') }}" method="POST">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="mobile" name="mobile" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('mobile') }}" required maxlength="10">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="phone" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" maxlength="11">
                                    <small class="form-text text-muted">Nhập đúng 10 số</small>
                                    @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="tax_code" name="tax_code" class="form-control @error('tax_code') is-invalid @enderror" value="{{ old('tax_code') }}" maxlength="10">
                                    <small class="form-text text-muted">Nhập đúng 10 số</small>
                                    @error('tax_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
